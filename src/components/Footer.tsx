      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="font-poppins text-sm text-secondary-foreground/80">
          ...
          <div>
            ...
            <ul className="space-y-2 font-poppins text-sm">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Flavors</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 font-poppins text-sm">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Combo Packs</a></li>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a href="#" className="w-10 h-10 rounded-full bg-primary/20 hover:bg-primary flex items-center justify-center transition-all duration-300 hover:scale-110">
        ...
        <div className="border-t border-secondary-foreground/20 pt-8 text-center">
          <p className="font-poppins text-sm text-secondary-foreground/60">
